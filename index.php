	      ...
	      <div class="section group">
			...
			?>
				<div class="grid_1_of_4 images_1_of_4">
					 <a href="details.php"><img src="admin/uploads/<?php echo $result['image']?>" alt="" height="180px" weight="120px" ></a>
			...
			?>
				<div class="grid_1_of_4 images_1_of_4">
					 <a href="details.php"><img src="admin/uploads/<?php echo $result_new['image']?>" alt="" height="180px" weight="120px" ></a>
